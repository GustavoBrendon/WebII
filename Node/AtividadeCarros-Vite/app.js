...
import carro_router from "./routers/api/carro_router.js";
import acessorio_router from "./routers/api/acessorio_router.js"
import motorista_router from "./routers/api/motorista_router.js"
...
app.use("/api/carros", carro_router);
app.use("/api/acessorios", acessorio_router);
app.use("/api/motoristas", motorista_router);
